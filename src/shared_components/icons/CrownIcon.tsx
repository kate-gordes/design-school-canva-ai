...
const SIZE_MAP: Record<'tiny' | 'small' | 'medium' | 'large' | 'xlarge', number> = {
  tiny: 12,
  small: 16,
  medium: 20,
  large: 24,
...
function resolveSize(size: IconProps['size'] | undefined): number {
...
export const CrownIcon: React.FC<IconProps> = ({ size = 'small', className }) => {
