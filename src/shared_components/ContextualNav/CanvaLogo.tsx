...
export default function CanvaLogo({ className }: CanvaLogoProps): JSX.Element {
  return (
    <svg
    ...
    >
      <defs>
        ...
        <pattern id="_2002046508__f" width="1" height="1" patternContentUnits="objectBoundingBox">
